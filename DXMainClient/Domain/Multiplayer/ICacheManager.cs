...
public interface ICacheManager<TInput, TOutput> : IDisposable
{
    ...
    /// <summary>
    /// Requests an output to be computed for the specified input. The output is owned by the cache manager. The caller MUST immediately use or copy the output and MUST NOT hold references to it.
    /// </summary>
