...
namespace DTAClient.DXGUI.Multiplayer
{
    class LANLobby : XNAWindow
    {
        ...
        public override void Initialize()
        {
            ...
            broadcastManager = new LANLobbyBroadcastManager(ProgramConstants.LAN_LOBBY_PORT, encoding, AddCallback);
            broadcastManager.MessageReceived += BroadcastManager_MessageReceived;
        ...
        private void BroadcastManager_MessageReceived(object sender, NetworkMessageReceivedEventArgs e)
        {
            HandleNetworkMessage(e.Data, e.EndPoint);
        }
